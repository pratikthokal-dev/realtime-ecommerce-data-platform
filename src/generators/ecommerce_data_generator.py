...
from src.kafka.kafka_producer import get_kafka_producer
...
# -----------------------------
# Generate Orders + Kafka Events
# -----------------------------

def generate_orders(cursor, producer, count=500):


    print(
        f"Generating {count} orders..."
    )
